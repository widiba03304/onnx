...
#define fail_type_inference(...) \
  ONNX_THROW_EX(onnx::InferenceError(onnx::MakeString("[TypeInferenceError] ", __VA_ARGS__)));

#define fail_shape_inference(...) \
  ONNX_THROW_EX(onnx::InferenceError(onnx::MakeString("[ShapeInferenceError] ", __VA_ARGS__)));
