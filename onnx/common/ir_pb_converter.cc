...
void convertAttribute(const onnx::AttributeProto& ap, Node* n, const int ir_version = IR_VERSION) {
...
void convertAttributes(onnx::NodeProto& np, Node* n, const int ir_version = IR_VERSION) {
...
std::unique_ptr<Graph> graphProtoToGraph(const onnx::GraphProto& gp, bool nested, const int ir_version) {
